...
For a fair comparison, the non-mapped configuration will make the compiler to decompose the circuit gates in the SC-17 gate set (see Fig. \ref{fig:decompositions}).
We will also try different configurations regarding the decoherence time and the error rates.
The results after simulating immediately confirmed that the mapping procedure affects the error amount in the quantum system.
In Fig. \ref{fig:orgc0918b6} we highlight some benchmarks difference in fidelity between being the non mapped circuit
