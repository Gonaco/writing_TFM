...
First, in the \hyperref[sec:org56395f9]{Impact of mapping in the overall circuit error} section we show how the mapping procedure affects the general increment of error.
After that, we analyze the metrics and their correlation with the error increase in the \hyperref[sec:orgdb7f017]{Analysis of the mapping metrics} section.

\section{Impact of mapping in the overall circuit error}
\label{sec:org56395f9}
