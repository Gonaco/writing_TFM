...
First, in the \hyperref[sec:org0472d53]{Impact of the mapping on the algorithm reliability} section we show how the mapping procedure affects the general increment of error.
After that, we analyze the metrics and their correlation with the error increase in the \hyperref[sec:org61109ff]{Analysis of the mapping metrics} section.

\section{Impact of the mapping on the algorithm reliability}
\label{sec:org0472d53}
...
\includegraphics[width=0.5\textwidth]{figures/mapping_effect_3000_diff_lines.eps}
...
\includegraphics[width=0.5\textwidth]{figures/mapping_effect_diff_3000.eps}
...
\includegraphics[width=0.5\textwidth]{figures/mapping_effect_1000_diff_lines.eps}
...
\includegraphics[width=0.5\textwidth]{figures/mapping_effect_diff_1000.eps}
