...
Throughout this thesis we use the terms */virtual/ qubits* and */physical/ qubits* referring to the qubits from the circuit we would like to adapt -- map -- and the real qubits in the quantum chip, respectively.
