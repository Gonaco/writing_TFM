...
\begin{equation}
|\Phi ^{+}\rangle =\frac  {1}{\sqrt  {2}}(|0\rangle _{\phi}\otimes |0\rangle _{\psi}+|1\rangle _{\phi}\otimes |1\rangle _{\psi}) = \frac{1}{\sqrt{2}} \left( \begin{bmatrix}1 \\ 1 \end{bmatrix} \otimes \begin{bmatrix}1 \\ 1 \end{bmatrix} \right) = \frac{1}{\sqrt{2}} \begin{bmatrix}1 \\ 1 \\ 1 \\ 1\end{bmatrix} =  \frac{(|00\rangle +|11\rangle )} {\sqrt {2}}
\end{equation}
...
Or what is the same, transformations of some Hilbert space.
As their classical siblings, the l
