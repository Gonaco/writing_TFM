...
\label{sec:orgcf3dbab}

\begin{itemize}
\item Error model parameters
\label{sec:org753022b}

\begin{table}[htbp]
\caption{\label{tab:org514452f}
...
The initial dephasing step in the measurement model (Fig. \ref{fig:orgd57c92f}) occurs due to the \hyperref[sec:orgf2bfd32]{photon decay} effect.
