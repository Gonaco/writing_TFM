...
In the \hyperref[sec:org7522185]{Benchmarks} section we describe how we built the algorithm set.
In the \hyperref[sec:orgda19d24]{Error framework} section we describe the structure of the mapping of the algorithms procedure and its posterior metric calculation.
...
OpenQL will be explained in much detail in the section \hyperref[sec:org5f4df50]{Compiler (OpenQL, cQASM)?}.

\section*{Benchmarks}
\label{sec:org7522185}
...
As mentioned in the introduction of this chapter and as it is shown in Section \hyperref[sec:org5f4df50]{Compiler (OpenQL, cQASM)?}, in order to map the algorithms we will use the OpenQL tool.
...
\begin{itemize}
\item cQASM
\label{sec:orgfd79597}


\item OpenQL
\label{sec:orga762ae1}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/openql.png}
\caption{\label{fig:org8cda7fd}
OpenQL diagram}
\end{figure}
