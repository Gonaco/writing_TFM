...
\label{sec:orga3bd756}
\section*{Benchmarks}
\label{sec:orgf974101}
\section*{Error framework}
\label{sec:org7d874d9}
\subsection*{Compiler (OpenQL, cQASM)?}
\label{sec:org2039d5f}
...
\begin{itemize}
\item cQASM
\label{sec:orgc92bcde}


\item OpenQL
\label{sec:org19008d9}
...
\label{sec:org8797b22}

\begin{itemize}
\item Error model parameters
\label{sec:org3780e1a}

\begin{table}[htbp]
\caption{\label{tab:org9165112}
...
The initial dephasing step in the measurement model (Fig. \ref{fig:orgcba4249}) occurs due to the \hyperref[sec:org91d9b0d]{photon decay} effect.
...
\label{sec:org0bba033}
\begin{itemize}
\item Optimization of logical error rates
\label{sec:org95712b0}

As they explain in the paper and one can see in Fig. \ref{fig:orgefb5cf6}, they find that the optimal measuring time for the minimum \(\epsilon_L\) is 280 ns.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figures/measure_t_optimization.png}
\caption{\label{fig:orgefb5cf6}
