...
\label{sec:org6af1708}
\section*{Benchmarks}
\label{sec:org1949257}
\section*{Error framework}
\label{sec:org19327d1}
\subsection*{Compiler (OpenQL, cQASM)?}
\label{sec:org1cf93ee}
...
\begin{itemize}
\item cQASM
\label{sec:org943073b}


\item OpenQL
\label{sec:orgd29b7dc}
...
\label{sec:org20f4bd2}

\begin{itemize}
\item Error model parameters
\label{sec:orge1e2a42}

\begin{table}[htbp]
\caption{\label{tab:org20cb65b}
...
The initial dephasing step in the measurement model (Fig. \ref{fig:orgb6bae4d}) occurs due to the \hyperref[sec:org54e2924]{photon decay} effect.
...
\label{sec:orgd59484b}
\begin{itemize}
\item Optimization of logical error rates
\label{sec:org73607f3}

As they explain in the paper and one can see in Fig. \ref{fig:org23c7f55}, they find that the optimal measuring time for the minimum \(\epsilon_L\) is 280 ns.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figures/measure_t_optimization.png}
\caption{\label{fig:org23c7f55}
...
\subsection*{QX}
\label{sec:orgba44700}
\subsection*{Error Framework}
\label{sec:orga1d87f9}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/error_framework_diagram.png}
\caption{\label{fig:orgd3370e8}
Error Framework}
\end{figure}

\begin{itemize}
\item Benchmark Object
\label{sec:orga254613}

\begin{figure}[htbp]
\centering
\includegraphics[width=.5\textwidth]{figures/benchmark_object.png}
\caption{\label{fig:org7acaebd}
Benchmark Object \ldots{}}
\end{figure}

\item Mapping Analysis Object
\label{sec:org381f547}

\begin{figure}[htbp]
\centering
\includegraphics[width=.5\textwidth]{figures/error_analysis.png}
\caption{\label{fig:orgb3bd5d6}
Mapping Analysis Object \ldots{}}
\end{figure}

\item Database
\label{sec:orgce421fa}

\begin{figure}[htbp]
\centering
\includegraphics[width=.75\textwidth]{figures/database_scheme_general.png}
\caption{\label{fig:org7b8b9d6}
Database tables}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/database_scheme_detail.png}
\caption{\label{fig:orgd699262}
