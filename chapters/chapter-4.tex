...
\label{sec:org4a28e15}
\section*{Benchmarks}
\label{sec:org3e8d91b}
\section*{Error framework}
\label{sec:org0c95aad}
\subsection*{Compiler (OpenQL, cQASM)?}
\label{sec:org1c00562}
...
\begin{itemize}
\item cQASM
\label{sec:org4e2d18f}


\item OpenQL
\label{sec:orgd2f3cc4}
...
\label{sec:org0c650d9}

\begin{itemize}
\item Error model parameters
\label{sec:org193ec06}

\begin{table}[htbp]
\caption{\label{tab:org1f3f2f3}
...
The initial dephasing step in the measurement model (Fig. \ref{fig:orgd3a6f86}) occurs due to the \hyperref[sec:orgfcfe1f2]{photon decay} effect.
...
\label{sec:org5fb1c93}
\begin{itemize}
\item Optimization of logical error rates
\label{sec:org52ecf79}

As they explain in the paper and one can see in Fig. \ref{fig:org832d814}, they find that the optimal measuring time for the minimum \(\epsilon_L\) is 280 ns.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figures/measure_t_optimization.png}
\caption{\label{fig:org832d814}
