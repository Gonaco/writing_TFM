...
In the \hyperref[sec:org6673bb7]{Benchmarks} section we describe how we built the algorithm set.
In the \hyperref[sec:org3bb9cf4]{Error framework} section we describe the structure of the mapping of the algorithms procedure and its posterior metric calculation.
...
OpenQL will be explained in much detail in the section \hyperref[sec:org54b4540]{Compiler (OpenQL, cQASM)?}.

\section*{Benchmarks}
\label{sec:org6673bb7}
...
As mentioned in the introduction of this chapter and as it is shown in Section \hyperref[sec:org54b4540]{Compiler (OpenQL, cQASM)?}, in order to map the algorithms we will use the OpenQL tool.
...
\begin{itemize}
\item cQASM
\label{sec:org5a573aa}


\item OpenQL
\label{sec:org10900dc}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/openql.png}
\caption{\label{fig:org7c1e500}
OpenQL diagram}
\end{figure}
