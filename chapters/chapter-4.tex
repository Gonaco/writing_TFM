...
In the \hyperref[sec:orge850a6e]{Benchmarks} section we describe how we built the algorithm set.
In the \hyperref[sec:org80b465a]{Error framework} section we describe the structure of the mapping of the algorithms procedure and its posterior metric calculation.
...
OpenQL will be explained in much detail in the section \hyperref[sec:orgda1c79c]{Compiler (OpenQL, cQASM)?}.

\section*{Benchmarks}
\label{sec:orge850a6e}
...
As mentioned in the introduction of this chapter and as it is shown in Section \hyperref[sec:orgda1c79c]{Compiler (OpenQL, cQASM)?}, in order to map the algorithms we will use the OpenQL tool.
...
\begin{itemize}
\item cQASM
\label{sec:orge3e6308}


\item OpenQL
\label{sec:org2c3b196}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/openql.png}
\caption{\label{fig:orgf2b1603}
OpenQL diagram}
\end{figure}
