...
As mentioned in the [[id:e9551941-a680-421a-aecc-8b103368acd6]] section in the second chapter, we name /mapping metrics/ to those metrics used to assert the quality of a mapper and that are also used by the mapper algorithm as an heuristic.
