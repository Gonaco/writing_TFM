...
So that we could do a proper assessment of mapping algorithms, in our study we analyzed these two metrics amongst other different ones as fidelity, probability of success or quantum volume and their relationship with the error generated after the mapping.
