...
\begin{figure}[h!]
\centerline{\subfigure[]{\includegraphics[width=2.5in]{figures/cell}
\label{cell}}
\subfigure[]{\includegraphics[width=2.5i]{figures/SC_17.png}
\label{SC17}}}
...
\begin{figure}[h!]
\centerline{\subfigure[]{\includegraphics[width=3in]{figures/sc-17}
\label{fig:sc_17}}
