...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/V_q_analysis_mult1.png}
\caption{\label{fig:orgb9efff4}
Algorithm Quantum Volume as in eq. \ref{eq:org85f5b32} behaviour for values less than 1000 qubits and a depth \(< 10^{5}\)}
\end{figure}

\item Runnability
\label{sec:org5359be2}
