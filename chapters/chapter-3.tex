...
\label{sec:orgb1f96df}



\subsection*{Latency}
\label{sec:org319ce04}

\subsection*{Probability of success}
\label{sec:orgad977d8}
...
\caption{\label{fig:org451b1c1}
Algorithm Quantum Volume as in eq. \ref{eq:org4879077} behaviour for values less than \(10^{4}\) qubits and depth less than \(10^{4}\)}
\end{figure}
...
\caption{\label{fig:orge20e0a2}
Algorithm Quantum Volume as in eq. \ref{eq:org4879077} behaviour for values less than 1000 qubits and a depth less than \(10^{5}\)}
\end{figure}
...
\caption{\label{fig:org2c38276}
Algorithm Quantum Volume as in eq. \ref{eq:org042b3d6} behaviour for values less than 1000 qubits and a depth less than \(10^{5}\)}
\end{figure}

\item Runnability
\label{sec:org4a0d5bb}
