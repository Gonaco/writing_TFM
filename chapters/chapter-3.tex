...
Although the work done in this thesis  could be apply to any quantum technology, we limit our study to the surface code 17 chip (Surface-17) developed by Leo Di Carlo's group at QuTech \textcolor{red}{Daniel, please add the reference to richard's paper}
...
In order to map quantum circuits on the superconducting quantum chip we will use the mapping model developed in our group \textcolor{red}{Add reference to Lingling's paper}.
