...
Although the work done in this thesis  could be apply to any quantum technology, we limit our study to the surface code 17 chip (SC-17) developed by Leo Di Carlo's group at QuTech \textcolor{red}{Daniel, please add the refenece to richard's paper}
In addtion, we will explain the mapping model and the metrics used in this work.
