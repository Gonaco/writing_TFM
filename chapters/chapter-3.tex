...
\label{sec:orgc1c109c}



\subsection*{Latency}
\label{sec:org8c8b8fd}

\subsection*{Probability of success}
\label{sec:orgb494dd7}
...
But, for a situation of having one of the states as pure state (eq. \ref{eq:orgd868b59}) or, even, having both (eq. \ref{eq:org915f350}); the fidelity calculation is much more simplistic.
...
\caption{\label{fig:orge5a3ab5}
Algorithm Quantum Volume as in eq. \ref{eq:org5ab3a1a} behaviour for values less than \(10^{4}\) qubits and depth less than \(10^{4}\)}
\end{figure}
...
\caption{\label{fig:org8ba43e1}
Algorithm Quantum Volume as in eq. \ref{eq:org5ab3a1a} behaviour for values less than 1000 qubits and a depth less than \(10^{5}\)}
\end{figure}
...
\caption{\label{fig:org6be510e}
Algorithm Quantum Volume as in eq. \ref{eq:orgc1c52cf} behaviour for values less than 1000 qubits and a depth less than \(10^{5}\)}
\end{figure}

\item Runnability
\label{sec:org2c63286}
