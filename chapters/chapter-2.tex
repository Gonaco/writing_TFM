...
\label{sec:orgcc6a7aa}
\section*{State of the art}
\label{sec:org17549c2}
...
\captionof{figure}{Gray encoder quantum circuit}
...
\captionof{figure}{Mapped Gray encoder for the SC-7 chip. Each circuit part surrounded by a dashed line is a cycle}
