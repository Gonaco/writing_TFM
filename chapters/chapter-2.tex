...
\label{sec:org68452f2}

\section*{Quantum computing}
\label{sec:org1dcfa54}
...
Dirac's notation grants the definition of the quantum states as vectors, as in eq. \ref{eq:org1f0e07a}.
...
E.g. in eq. \ref{eq:org64ebb03} the vectors of the ground, excited and the plus superposition -- a quantum state with the same probability to get either \(|0\rangle\) or \(|1\rangle\) -- states are depicted, respectively.
...
As soon as the vectors are 2-dimensional, complex and unitary they can also be described in phase notation (eq. \ref{eq:orgbcb98fe}).
...
In eq. \ref{eq:org8d888f2} an example of the outer product is offered.
...
\item Quantum Gates
\label{sec:orgdbdb40b}

\begin{itemize}
\item Single-qubit gates
\label{sec:orgcc9a47a}

\item Two-qubit gates
\label{sec:org92ce9b9}
\end{itemize}
\end{itemize}
\subsection*{Quantum Circuits}
\label{sec:orge73a38d}

\section*{Mapping of quantum circuits}
\label{sec:org7d8bb1d}

\subsection*{Mapping}
\label{sec:org7ff9981}
...
\label{sec:orgef26b66}

\begin{itemize}
\item Example
\label{sec:org8aa46fc}
\begin{itemize}
\item Original
\label{sec:org290876d}
...
\label{sec:org4364272}
\begin{itemize}
\item :BMCOL:
\label{sec:org8a66a3c}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:orgd7b2cbc}
...
\label{sec:org8de6e7c}


\begin{itemize}
\item Example definition
\label{sec:org0676451}
\begin{itemize}
\item Example definition
\label{sec:org84dbcbb}
\begin{center}
...
\label{sec:org76b3743}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgdcb88d5}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:org423e805}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org6502e82}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org06fdcaa}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org56b4122}
...
\label{sec:org2d902c2}
\begin{itemize}
\item Example definition
\label{sec:orgfd53a03}
\begin{itemize}
\item Example definition
\label{sec:org4856fbb}
\begin{center}
...
\label{sec:orgef8f170}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org0908572}
\begin{center}
...
\item :BMCOL:
\label{sec:org2a05fe6}



\item Gray Code Quantum Circuit
\label{sec:orgf02f280}
\uline{Gray Code Quantum Circuit}
...
\label{sec:org9c4626f}
\begin{itemize}
\item Example definition
\label{sec:org61bb621}
\begin{itemize}
\item Example definition
\label{sec:org9dc2496}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgf0e105e}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org30153c8}
\begin{center}
...
\item :BMCOL:
\label{sec:org97d1515}



\item Gray Code Quantum Circuit
\label{sec:org9b7515e}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org281cc64}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orgeaf4d7d}
\begin{itemize}
\item Example definition
\label{sec:org6216500}
\begin{itemize}
\item Example definition
\label{sec:org14c2b8d}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org4af6a86}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org10d054e}
\begin{center}
...
\item :BMCOL:
\label{sec:org6c39b3c}



\item Gray Code Quantum Circuit
\label{sec:org7999391}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org9015ce6}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org49766d9}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:org1cf82e8}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org72b5d7c}

\begin{itemize}
\item Circuits
\label{sec:orgce1d5c0}
\begin{itemize}
\item :BMCOL:
\label{sec:org4086ffe}
      \begin{center}
...
\label{sec:org365cd0d}

\begin{itemize}
\item :BMCOL:
\label{sec:org7de40dd}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org9e874db}
Error sources:
...
\item :BMCOL:
\label{sec:org692c3a6}
\begin{itemize}
\item Windows error image
\label{sec:org82b65e4}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgf34cd6f}

\item Best Mapping
\label{sec:orgf70ce6b}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgd987bb0}
...
\label{sec:org0700d58}

\begin{itemize}
\item Index
\label{sec:org580774f}
\begin{itemize}
\item What is the people doing?
\label{sec:orgcc5a7a0}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org27be5e5}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgb53baa0}
...
\label{sec:orgf4ae81f}

\begin{itemize}
\item SC-17 topology
\label{sec:org1d572fb}
\begin{itemize}
\item Images
\label{sec:org6b760d0}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:org3f36cca}
...
\item Constraints
\label{sec:orgf432d50}
\begin{itemize}
\item :BMCOL:
\label{sec:org8100da0}
Constraints:
