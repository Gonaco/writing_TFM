...
\label{sec:org4def0d0}

\section*{Quantum computing}
\label{sec:org9d61443}
...
\label{sec:org4b0ced4}
\begin{itemize}
\item :BMCOL:
\label{sec:orgda89de4}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:org6da23ff}
...
\label{sec:org49fb939}


\begin{itemize}
\item Example definition
\label{sec:orgc4e5659}
\begin{itemize}
\item Example definition
\label{sec:orge7a2682}
\begin{center}
...
\label{sec:org3eb0633}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org42e1dff}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:org83efd1c}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org294dbb9}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org30784e9}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org6349520}
...
\label{sec:orgb03e759}
\begin{itemize}
\item Example definition
\label{sec:orgdb0fa23}
\begin{itemize}
\item Example definition
\label{sec:org99439d6}
\begin{center}
...
\label{sec:org93c4886}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org204e1d3}
\begin{center}
...
\item :BMCOL:
\label{sec:org6411291}



\item Gray Code Quantum Circuit
\label{sec:org1ef4f20}
\uline{Gray Code Quantum Circuit}
...
\label{sec:orgf7b21f4}
\begin{itemize}
\item Example definition
\label{sec:org74bc07a}
\begin{itemize}
\item Example definition
\label{sec:org1a73bff}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org5e45881}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org34b624b}
\begin{center}
...
\item :BMCOL:
\label{sec:orgd870df5}



\item Gray Code Quantum Circuit
\label{sec:org1d1d022}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org0b924d6}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orgf5deb9c}
\begin{itemize}
\item Example definition
\label{sec:orgd7c25b6}
\begin{itemize}
\item Example definition
\label{sec:orgaebeceb}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org864e1b1}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orga30fd3b}
\begin{center}
...
\item :BMCOL:
\label{sec:org827a3ff}



\item Gray Code Quantum Circuit
\label{sec:orgec346a8}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org60d3545}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org06d5246}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgdd98d18}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org47c5ce8}

\begin{itemize}
\item Circuits
\label{sec:orgba8024f}
\begin{itemize}
\item :BMCOL:
\label{sec:orgd8cfeff}
      \begin{center}
...
\label{sec:org90a32f2}

\begin{itemize}
\item :BMCOL:
\label{sec:org8c461c4}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgf4a1fd7}
Error sources:
...
\item :BMCOL:
\label{sec:org6a2e7cd}
\begin{itemize}
\item Windows error image
\label{sec:org821e763}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orga5c0f37}

\item Best Mapping
\label{sec:org05e40e8}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org4334f86}
...
\label{sec:org5211a84}

\begin{itemize}
\item Index
\label{sec:orgca8f94e}
\begin{itemize}
\item What is the people doing?
\label{sec:orgcff2a41}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgdec2b4f}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orga1baf75}
...
\label{sec:orgc2b76b8}

\begin{itemize}
\item SC-17 topology
\label{sec:org964fb9a}
\begin{itemize}
\item Images
\label{sec:orga0ffad0}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:org05d987a}
...
\item Constraints
\label{sec:org41d24b9}
\begin{itemize}
\item :BMCOL:
\label{sec:org0a35b16}
Constraints:
