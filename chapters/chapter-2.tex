...
\label{sec:orgd7275b8}

\section*{Quantum computing}
\label{sec:org1b8db93}
...
Dirac's notation grants the definition of the quantum states as vectors, as in eq. \ref{eq:orgeecb4d2}.
...
E.g. in eq. \ref{eq:orgca022aa} the vectors of the ground, excited and the plus superposition -- a quantum state with the same probability to get either \(|0\rangle\) or \(|1\rangle\) -- states are depicted, respectively.
...
\item Quantum Gates
\label{sec:orgbb750d2}
\end{itemize}
\subsection*{Quantum Circuits}
\label{sec:org7ebc968}

\section*{Mapping of quantum circuits}
\label{sec:orgf01b8de}

\subsection*{Mapping}
\label{sec:org3663a38}
...
\label{sec:orgd2ec87b}

\begin{itemize}
\item Example
\label{sec:orgb7f7841}
\begin{itemize}
\item Original
\label{sec:org439511a}
...
\label{sec:org074d4b3}
\begin{itemize}
\item :BMCOL:
\label{sec:org7a436df}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:org1551abc}
...
\label{sec:orgaf8c1c2}


\begin{itemize}
\item Example definition
\label{sec:orgfcfc93c}
\begin{itemize}
\item Example definition
\label{sec:orgd08116e}
\begin{center}
...
\label{sec:orgdb03497}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org9614736}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:org09b88a1}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org4661fa2}
\begin{center}
...
\label{sec:orgbe9032e}
\begin{itemize}
\item Example definition
\label{sec:org6f7af48}
\begin{itemize}
\item Example definition
\label{sec:org6635612}
\begin{center}
...
\label{sec:org70e7fb1}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org9e6143d}
\begin{center}
...
\item :BMCOL:
\label{sec:org54756c2}



\item Gray Code Quantum Circuit
\label{sec:org2f1d217}
\uline{Gray Code Quantum Circuit}
...
\label{sec:org1946c15}
\begin{itemize}
\item Example definition
\label{sec:orgfea1112}
\begin{itemize}
\item Example definition
\label{sec:org3e931af}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org2ca055c}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org856adca}
\begin{center}
...
\item :BMCOL:
\label{sec:org6de7ecf}



\item Gray Code Quantum Circuit
\label{sec:org5f47b29}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org5f5eb50}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:org26c3a69}
\begin{itemize}
\item Example definition
\label{sec:org72dfdd0}
\begin{itemize}
\item Example definition
\label{sec:org509c81d}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org38547fe}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org5e2223f}
\begin{center}
...
\item :BMCOL:
\label{sec:org08682de}



\item Gray Code Quantum Circuit
\label{sec:org42f861f}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgb7f7e7b}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org0364333}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:org9a659b6}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:orga1a4de5}

\begin{itemize}
\item Circuits
\label{sec:orge02b3d6}
\begin{itemize}
\item :BMCOL:
\label{sec:org0ec8bfa}
      \begin{center}
...
\begin{itemize}
\item :BMCOL:
\label{sec:org88f84b4}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgee09136}
Error sources:
...
\item :BMCOL:
\label{sec:orgdd560fc}
\begin{itemize}
\item Windows error image
\label{sec:orgc70ef7b}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org1fa7c93}

\item Best Mapping
\label{sec:org17008eb}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org187b3a7}
...
\label{sec:org8ce7a76}

\begin{itemize}
\item Index
\label{sec:orgd377f18}
\begin{itemize}
\item What is the people doing?
\label{sec:org7da37d0}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org971a156}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org41cd49b}
...
\label{sec:org264ce13}

\begin{itemize}
\item SC-17 topology
\label{sec:orgb571338}
\begin{itemize}
\item Images
\label{sec:org8dd7fd3}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:org6d50ae8}
...
\item Constraints
\label{sec:org0b531f1}
\begin{itemize}
\item :BMCOL:
\label{sec:orga735c58}
Constraints:
