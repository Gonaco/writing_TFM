...
\label{sec:orgdbd9046}

\section*{Quantum computing}
\label{sec:org380e98d}
...
Dirac's notation grants the definition of the quantum states as vectors, as in eq. \ref{eq:org677606b}.
...
E.g. in eq. \ref{eq:org38cb8a8} the vectors of the ground, excited and the plus superposition -- a quantum state with the same probability to get either \(|0\rangle\) or \(|1\rangle\) -- states are depicted, respectively.
...
As soon as the vectors are 2-dimensional, complex and unitary they can also be described in phase notation (eq. \ref{eq:orgd2010bf}).
...
In eq. \ref{eq:org681dc7f} an example of the outer product is offered.
...
\item Quantum Gates
\label{sec:orgfeef4bb}

\begin{itemize}
\item Single-qubit gates
\label{sec:org0017f12}

\item Two-qubit gates
\label{sec:org4093e67}
\end{itemize}
\end{itemize}
\subsection*{Quantum Circuits}
\label{sec:orgdef9b4d}

\section*{Mapping of quantum circuits}
\label{sec:orgf2ac933}

\subsection*{Mapping}
\label{sec:orgc4f8e5c}
...
\label{sec:org4ce5191}

\begin{itemize}
\item Example
\label{sec:org60a6574}
\begin{itemize}
\item Original
\label{sec:orga86a2af}
...
\label{sec:org884b135}
\begin{itemize}
\item :BMCOL:
\label{sec:orge146c92}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:org7ed996d}
...
\label{sec:orgacf73c0}


\begin{itemize}
\item Example definition
\label{sec:org849f35b}
\begin{itemize}
\item Example definition
\label{sec:org3b152a5}
\begin{center}
...
\label{sec:org91f30a7}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org7c82e05}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgc74698d}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgac2f85e}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org9b701f3}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgb13a71e}
...
\label{sec:org3716101}
\begin{itemize}
\item Example definition
\label{sec:org941eeee}
\begin{itemize}
\item Example definition
\label{sec:org425097e}
\begin{center}
...
\label{sec:orgc38416b}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org6d532c2}
\begin{center}
...
\item :BMCOL:
\label{sec:org3d64001}



\item Gray Code Quantum Circuit
\label{sec:org3c1fcee}
\uline{Gray Code Quantum Circuit}
...
\label{sec:orgf37f0ff}
\begin{itemize}
\item Example definition
\label{sec:orgc3c0ffe}
\begin{itemize}
\item Example definition
\label{sec:org14a878e}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org09dc4c8}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org3d86a16}
\begin{center}
...
\item :BMCOL:
\label{sec:orgc972eb9}



\item Gray Code Quantum Circuit
\label{sec:org5018eb2}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org45d770a}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orgce8389c}
\begin{itemize}
\item Example definition
\label{sec:org8aae743}
\begin{itemize}
\item Example definition
\label{sec:org107f192}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org65a93c0}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgeb5f0f2}
\begin{center}
...
\item :BMCOL:
\label{sec:orgda8caf1}



\item Gray Code Quantum Circuit
\label{sec:org14d5dbe}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org779d5a6}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org58f4e7e}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:org2b90e13}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:orgbed5d71}

\begin{itemize}
\item Circuits
\label{sec:org7638c98}
\begin{itemize}
\item :BMCOL:
\label{sec:orgf6ba56d}
      \begin{center}
...
\label{sec:orge5812c4}

\begin{itemize}
\item :BMCOL:
\label{sec:org287ddbb}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org135b9de}
Error sources:
...
\item :BMCOL:
\label{sec:orgf7407ec}
\begin{itemize}
\item Windows error image
\label{sec:org7cac2ee}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org50b08a7}

\item Best Mapping
\label{sec:org3aef76d}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgc158514}
...
\label{sec:org2d07c62}

\begin{itemize}
\item Index
\label{sec:org41dedb6}
\begin{itemize}
\item What is the people doing?
\label{sec:org2d13b27}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org6952d4c}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgc81a417}
...
\label{sec:orgaf8b45b}

\begin{itemize}
\item SC-17 topology
\label{sec:org86b332a}
\begin{itemize}
\item Images
\label{sec:orgf44dd17}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:orge7b322a}
...
\item Constraints
\label{sec:org18a95b1}
\begin{itemize}
\item :BMCOL:
\label{sec:org6a06dd0}
Constraints:
