...
\item Quantum Gates
\label{sec:org70ddd99}
\end{itemize}
\subsection*{Quantum Circuits}
\label{sec:org849cdd0}

\section*{Mapping of quantum circuits}
\label{sec:org1aaadcb}

\subsection*{Mapping}
\label{sec:orgb587ce9}
...
\label{sec:org250a941}

\begin{itemize}
\item Example
\label{sec:org4030061}
\begin{itemize}
\item Original
\label{sec:orgb7dd46e}
...
\label{sec:org1c8595c}
\begin{itemize}
\item :BMCOL:
\label{sec:orgd4cfe07}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:orgf311249}
...
\label{sec:orgf259cf6}


\begin{itemize}
\item Example definition
\label{sec:org450e0a7}
\begin{itemize}
\item Example definition
\label{sec:orge1873b3}
\begin{center}
...
\label{sec:org30602c9}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgec7ef8e}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:org79ee575}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgece455a}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org1c1cf51}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org017de32}
...
\label{sec:org0485522}
\begin{itemize}
\item Example definition
\label{sec:org27c5c29}
\begin{itemize}
\item Example definition
\label{sec:orgdeaca7c}
\begin{center}
...
\label{sec:orgffe0478}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org8cda96e}
\begin{center}
...
\item :BMCOL:
\label{sec:orgbcf9db6}



\item Gray Code Quantum Circuit
\label{sec:org28daf6b}
\uline{Gray Code Quantum Circuit}
...
\label{sec:org67aa029}
\begin{itemize}
\item Example definition
\label{sec:orga7569f4}
\begin{itemize}
\item Example definition
\label{sec:orgdbe0e80}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgd6b8405}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org1ce351c}
\begin{center}
...
\item :BMCOL:
\label{sec:org41cb098}



\item Gray Code Quantum Circuit
\label{sec:orgcdfdf8f}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org1b5210d}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orgd913638}
\begin{itemize}
\item Example definition
\label{sec:org7d4d280}
\begin{itemize}
\item Example definition
\label{sec:org5433701}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org26c070c}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgb5268f5}
\begin{center}
...
\item :BMCOL:
\label{sec:orga240c69}



\item Gray Code Quantum Circuit
\label{sec:org0eda864}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgdfe6924}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgd5674ba}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:org2a17495}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org41c2821}

\begin{itemize}
\item Circuits
\label{sec:orgbab8126}
\begin{itemize}
\item :BMCOL:
\label{sec:org39afe66}
      \begin{center}
...
\label{sec:orgbf168c7}

\begin{itemize}
\item :BMCOL:
\label{sec:orgf70fce5}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org3b4be0f}
Error sources:
...
\item :BMCOL:
\label{sec:orgad029a6}
\begin{itemize}
\item Windows error image
\label{sec:org282beb2}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgffe47b4}

\item Best Mapping
\label{sec:org1586966}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orga087dd6}
...
\label{sec:org1539d11}

\begin{itemize}
\item Index
\label{sec:org823959e}
\begin{itemize}
\item What is the people doing?
\label{sec:org156db8f}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orga32240f}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org953d642}
...
\label{sec:orgfde7659}

\begin{itemize}
\item SC-17 topology
\label{sec:org3fe34de}
\begin{itemize}
\item Images
\label{sec:orga2ca6ea}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:org7451f05}
...
\item Constraints
\label{sec:org0e47f89}
\begin{itemize}
\item :BMCOL:
\label{sec:orgff947b4}
Constraints:
