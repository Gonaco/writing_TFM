...
\label{sec:org39c860a}

\section*{Quantum computing}
\label{sec:org2ea7dfe}
...
\label{sec:org1e81604}
\begin{itemize}
\item :BMCOL:
\label{sec:org32c10a1}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:org32ac03e}
...
\label{sec:org7c9ee63}


\begin{itemize}
\item Example definition
\label{sec:org48dc9d7}
\begin{itemize}
\item Example definition
\label{sec:org8cb23b0}
\begin{center}
...
\label{sec:org3189f85}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org2e7bdb0}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgc625bf4}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgec71ba3}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgf3d2822}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgb6d02e7}
...
\label{sec:org4b3c48b}
\begin{itemize}
\item Example definition
\label{sec:orgdc81be9}
\begin{itemize}
\item Example definition
\label{sec:org65ba0c3}
\begin{center}
...
\label{sec:org73f184f}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org92ce616}
\begin{center}
...
\item :BMCOL:
\label{sec:org8cdea44}



\item Gray Code Quantum Circuit
\label{sec:orga1e411b}
\uline{Gray Code Quantum Circuit}
...
\label{sec:org470c6ce}
\begin{itemize}
\item Example definition
\label{sec:org29f9ec6}
\begin{itemize}
\item Example definition
\label{sec:orgcedbcb4}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org0cb38a3}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org3f2a238}
\begin{center}
...
\item :BMCOL:
\label{sec:org200d0e2}



\item Gray Code Quantum Circuit
\label{sec:orgfecb971}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org18c1894}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orgd800be7}
\begin{itemize}
\item Example definition
\label{sec:org8ea70b0}
\begin{itemize}
\item Example definition
\label{sec:org0f8571a}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org80d8891}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org02a3f89}
\begin{center}
...
\item :BMCOL:
\label{sec:orgd378b27}



\item Gray Code Quantum Circuit
\label{sec:orga2cc8a3}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgef4110c}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orga1b887d}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:org1b41ce5}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org3611741}

\begin{itemize}
\item Circuits
\label{sec:org54bd4ba}
\begin{itemize}
\item :BMCOL:
\label{sec:org4b0bd8a}
      \begin{center}
...
\label{sec:org0f5124e}

\begin{itemize}
\item :BMCOL:
\label{sec:orgbebe0ea}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org2acefa0}
Error sources:
...
\item :BMCOL:
\label{sec:orgf601351}
\begin{itemize}
\item Windows error image
\label{sec:orge3c2574}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org084d49f}

\item Best Mapping
\label{sec:org541999f}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org3769d44}
...
\label{sec:org04a64cf}

\begin{itemize}
\item Index
\label{sec:org7380346}
\begin{itemize}
\item What is the people doing?
\label{sec:orge141022}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgd755831}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org205f528}
...
\label{sec:org7bc9f7c}

\begin{itemize}
\item SC-17 topology
\label{sec:orgd0c198c}
\begin{itemize}
\item Images
\label{sec:org11e4cf6}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:orgafa0381}
...
\item Constraints
\label{sec:org24c85ca}
\begin{itemize}
\item :BMCOL:
\label{sec:orgeb20002}
Constraints:
