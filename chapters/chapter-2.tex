...
\item Quantum Gates
\label{sec:orge7f2196}
\end{itemize}
\subsection*{Quantum Circuits}
\label{sec:org6d12d82}

\section*{Mapping of quantum circuits}
\label{sec:org58415cf}

\subsection*{Mapping}
\label{sec:orgd481b35}
...
\label{sec:org5545c51}

\begin{itemize}
\item Example
\label{sec:orgf2cd721}
\begin{itemize}
\item Original
\label{sec:org6eb44d1}
...
\label{sec:org35b6a07}
\begin{itemize}
\item :BMCOL:
\label{sec:org2a1f58e}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:org4a51756}
...
\label{sec:orge9d656d}


\begin{itemize}
\item Example definition
\label{sec:orgb7eaaac}
\begin{itemize}
\item Example definition
\label{sec:org6a920d5}
\begin{center}
...
\label{sec:orga4c61e9}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org5c78dfa}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:org9577547}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orga458456}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org9112158}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orge13b521}
...
\label{sec:org817a1e3}
\begin{itemize}
\item Example definition
\label{sec:org3d57e15}
\begin{itemize}
\item Example definition
\label{sec:org1c2f615}
\begin{center}
...
\label{sec:orgd555621}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgd484575}
\begin{center}
...
\item :BMCOL:
\label{sec:orge8c09ab}



\item Gray Code Quantum Circuit
\label{sec:org72d7e6a}
\uline{Gray Code Quantum Circuit}
...
\label{sec:org0d0ea97}
\begin{itemize}
\item Example definition
\label{sec:orgb5437d7}
\begin{itemize}
\item Example definition
\label{sec:org43374bb}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgc7f3b09}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org130adf1}
\begin{center}
...
\item :BMCOL:
\label{sec:orga734486}



\item Gray Code Quantum Circuit
\label{sec:org1a58470}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org1e459ce}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orgf7428d6}
\begin{itemize}
\item Example definition
\label{sec:org062d3fb}
\begin{itemize}
\item Example definition
\label{sec:orgf031d5f}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgdc896d5}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org09c44f6}
\begin{center}
...
\item :BMCOL:
\label{sec:org07ce166}



\item Gray Code Quantum Circuit
\label{sec:orgf844a88}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgdbf1b7e}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgb933430}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:orga3f9555}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org47e2cbb}

\begin{itemize}
\item Circuits
\label{sec:org57e634d}
\begin{itemize}
\item :BMCOL:
\label{sec:org078ea49}
      \begin{center}
...
\label{sec:org8eb1639}

\begin{itemize}
\item :BMCOL:
\label{sec:orgdd9c21b}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org20b0e7a}
Error sources:
...
\item :BMCOL:
\label{sec:org57e6ec2}
\begin{itemize}
\item Windows error image
\label{sec:org4990568}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgec1185c}

\item Best Mapping
\label{sec:org6dc7044}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org5a9cb5d}
...
\label{sec:org66a50c2}

\begin{itemize}
\item Index
\label{sec:orgb6b18f4}
\begin{itemize}
\item What is the people doing?
\label{sec:org060ed2e}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org4f68a95}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orge2e1608}
...
\label{sec:orga4f1fec}

\begin{itemize}
\item SC-17 topology
\label{sec:org3887f60}
\begin{itemize}
\item Images
\label{sec:org1c2ce8b}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:org32938ca}
...
\item Constraints
\label{sec:orgb4b54ac}
\begin{itemize}
\item :BMCOL:
\label{sec:orgd8631ac}
Constraints:
