...
\label{sec:org9bfa500}

\section*{Quantum computing}
\label{sec:orgd7e6f6c}
...
Dirac's notation grants the definition of the quantum states as vectors, as in eq. \ref{eq:org29ce060}.
...
E.g. in eq. \ref{eq:org0d63907} the vectors of the ground, excited and the plus superposition -- a quantum state with the same probability to get either \(|0\rangle\) or \(|1\rangle\) -- states are depicted, respectively.
...
\item Quantum Gates
\label{sec:orge54c72e}
\end{itemize}
\subsection*{Quantum Circuits}
\label{sec:org1085c6c}

\section*{Mapping of quantum circuits}
\label{sec:org54edd6d}

\subsection*{Mapping}
\label{sec:orge61e36e}
...
\label{sec:orgc2c91da}

\begin{itemize}
\item Example
\label{sec:orgfab2b48}
\begin{itemize}
\item Original
\label{sec:org30457a7}
...
\label{sec:org2cfabc9}
\begin{itemize}
\item :BMCOL:
\label{sec:orgb8b7063}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:orgec3efb0}
...
\label{sec:org1d09891}


\begin{itemize}
\item Example definition
\label{sec:orgf888f7c}
\begin{itemize}
\item Example definition
\label{sec:orgdf595d0}
\begin{center}
...
\label{sec:org068f324}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org4efea10}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:org1a8a58c}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org30a3754}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgde70c27}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org63b33cf}
...
\label{sec:org7d54961}
\begin{itemize}
\item Example definition
\label{sec:org970cacf}
\begin{itemize}
\item Example definition
\label{sec:orgcd7322f}
\begin{center}
...
\label{sec:org7630971}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgd10b547}
\begin{center}
...
\item :BMCOL:
\label{sec:org8787ec8}



\item Gray Code Quantum Circuit
\label{sec:org380e7cf}
\uline{Gray Code Quantum Circuit}
...
\label{sec:org4f207b6}
\begin{itemize}
\item Example definition
\label{sec:org85b4125}
\begin{itemize}
\item Example definition
\label{sec:org1296477}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org02c6a7a}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org9546a13}
\begin{center}
...
\item :BMCOL:
\label{sec:org16ab761}



\item Gray Code Quantum Circuit
\label{sec:org68a47f9}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgc4a5a08}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orgc20c8d3}
\begin{itemize}
\item Example definition
\label{sec:org78c9f9c}
\begin{itemize}
\item Example definition
\label{sec:org3f16b56}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgf438a01}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org885f30f}
\begin{center}
...
\item :BMCOL:
\label{sec:orgdb2de84}



\item Gray Code Quantum Circuit
\label{sec:orge3729cb}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgfddf0f4}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org9049d3d}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgeddcce7}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org70f840a}

\begin{itemize}
\item Circuits
\label{sec:orgc15cb53}
\begin{itemize}
\item :BMCOL:
\label{sec:org5f8bd3d}
      \begin{center}
...
\label{sec:orgb1a1ac5}

\begin{itemize}
\item :BMCOL:
\label{sec:orgeb62ee2}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org734120c}
Error sources:
...
\item :BMCOL:
\label{sec:org121f193}
\begin{itemize}
\item Windows error image
\label{sec:org2847a61}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgb6b646c}

\item Best Mapping
\label{sec:org278ee92}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgbb0995f}
...
\label{sec:org42cdabd}

\begin{itemize}
\item Index
\label{sec:org89d5ea4}
\begin{itemize}
\item What is the people doing?
\label{sec:org2ab081f}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org3fd3635}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgd4e5252}
...
\label{sec:orgad7ecdb}

\begin{itemize}
\item SC-17 topology
\label{sec:orgcc0bfd1}
\begin{itemize}
\item Images
\label{sec:orgb2c6d03}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:org2fe94ec}
...
\item Constraints
\label{sec:org683ce3a}
\begin{itemize}
\item :BMCOL:
\label{sec:org6ea2e43}
Constraints:
