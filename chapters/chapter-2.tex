...
\label{sec:org927dad6}
\section*{State of the art}
\label{sec:org5c7a169}
...
\subcaption[Gray encoder quantum circuit]
...
\subcaption[Mapped Gray encoder for the SC-7 chip. Each circuit part surrounded by a dashed line is a cycle]
