...
\label{sec:org6bfe300}

\section*{Quantum computing}
\label{sec:orga09644f}
...
Dirac's notation grants the definition of the quantum states as vectors, as in eq. \ref{eq:org71871e7}.
...
E.g. in eq. \ref{eq:org9901668} the vectors of the ground, excited and the plus superposition -- a quantum state with the same probability to measure either \(|0\rangle\) or \(|1\rangle\) -- states are depicted, respectively.
...
As soon as the vectors are 2-dimensional, complex and unitary they can also be described in phase notation (eq. \ref{eq:org096ce17}).
...
In eq. \ref{eq:orgf09ea52} and \ref{eq:orgd0aa045} an example of the outer product is offered.
...
For instance, in eq. \ref{eq:org256bacb} \ldots{}
...
\label{sec:org13380cb}

\item Two-qubit gates
\label{sec:org76818a5}
\end{itemize}
\end{itemize}

\subsection*{Quantum Circuits}
\label{sec:org203fbb9}
...
An example of the Gray code construction is shown in \ref{fig:org3d8d02a}
The QASM algorithm representation can be seen in code \ref{orgcb7a9a7}.
...
\label{sec:org43f9ee1}

\subsection*{Mapping}
\label{sec:org984f7b3}
...
\label{sec:org5744feb}

\begin{itemize}
\item Example
\label{sec:org8490878}
\begin{itemize}
\item Original
\label{sec:org6c4bc2f}
...
\label{sec:org2053ee1}
\begin{itemize}
\item :BMCOL:
\label{sec:orge72f78a}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:orgf6f49bf}
...
\label{sec:org3652a97}


\begin{itemize}
\item Example definition
\label{sec:orgb0177f1}
\begin{itemize}
\item Example definition
\label{sec:orgcea578a}
\begin{center}
...
\label{sec:org8855109}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgc0dbe22}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:org896f907}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgd07fb3b}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org0deb8fe}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org04b533b}
...
\label{sec:org891873f}
\begin{itemize}
\item Example definition
\label{sec:org21ee7ba}
\begin{itemize}
\item Example definition
\label{sec:org19b7c8b}
\begin{center}
...
\label{sec:org0631e2e}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org7a4b799}
\begin{center}
...
\item :BMCOL:
\label{sec:org46269c4}



\item Gray Code Quantum Circuit
\label{sec:orgd8ce0dc}
\uline{Gray Code Quantum Circuit}
...
\label{sec:org084bdde}
\begin{itemize}
\item Example definition
\label{sec:org10f9398}
\begin{itemize}
\item Example definition
\label{sec:orgad38a23}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org1a4982e}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org537de4f}
\begin{center}
...
\item Gray Code Quantum Circuit
\label{sec:orga665253}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org6123f01}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orgfb11d4c}
\begin{itemize}
\item Example definition
\label{sec:org3b06833}
\begin{itemize}
\item Example definition
\label{sec:org169ef02}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgb9921a4}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org2c4fe2d}
\begin{center}
...
\item :BMCOL:
\label{sec:org4040443}



\item Gray Code Quantum Circuit
\label{sec:orga4a3d8a}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgbcd26e8}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org03b01f7}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:org7f3d9cc}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org3b1f956}

\begin{itemize}
\item Circuits
\label{sec:org0eaa69c}
\begin{itemize}
\item :BMCOL:
\label{sec:org17eaf60}
      \begin{center}
...
\label{sec:org1994db2}

\begin{itemize}
\item :BMCOL:
\label{sec:orgb998833}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org901bffc}
Error sources:
...
\item :BMCOL:
\label{sec:orgafdf421}
\begin{itemize}
\item Windows error image
\label{sec:org8c2d87d}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orge6045ec}

\item Best Mapping
\label{sec:orgb9374d7}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgb740915}
...
\label{sec:org0c79606}

\begin{itemize}
\item Index
\label{sec:org6095c41}
\begin{itemize}
\item What is the people doing?
\label{sec:orgd733a6b}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orge39adca}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org998ce33}
...
\label{sec:orge45660d}

\begin{itemize}
\item SC-17 topology
\label{sec:org18efea4}
\begin{itemize}
\item Images
\label{sec:orgeb37407}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:orgeb0670b}
...
\item Constraints
\label{sec:org62fec51}
\begin{itemize}
\item :BMCOL:
\label{sec:orgdeff9fc}
Constraints:
