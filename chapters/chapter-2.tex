...
\label{sec:orgdff32ff}

\section*{Quantum computing}
\label{sec:org8596a8d}
...
Dirac's notation grants the definition of the quantum states as vectors, as in eq. \ref{eq:orgcbef0a1}.
...
E.g. in eq. \ref{eq:orgff1353d} the vectors of the ground, excited and the plus superposition -- a quantum state with the same probability to measure either \(|0\rangle\) or \(|1\rangle\) -- states are depicted, respectively.
...
As soon as the vectors are 2-dimensional, complex and unitary they can also be described in phase notation (eq. \ref{eq:orgbace504}).
...
In eq. \ref{eq:org3ab8b50} and \ref{eq:org6a9be56} an example of the outer product is offered.
...
For instance, in eq. \ref{eq:orgb773f46} \ldots{}
...
\label{sec:org79df65e}

\item Two-qubit gates
\label{sec:orgea6afa1}
\end{itemize}
\end{itemize}

\subsection*{Quantum Circuits}
\label{sec:orgfd6eb44}
...
An example of the Gray code construction is shown in \ref{fig:orgcc77ee2}
The QASM algorithm representation can be seen in code \ref{org1872284}.
...
\label{sec:org5772b6a}

\subsection*{Mapping}
\label{sec:org7367e53}
...
\label{sec:orgb0faef2}

\begin{itemize}
\item Example
\label{sec:orga8da1f0}
\begin{itemize}
\item Original
\label{sec:org5c271ee}
...
\label{sec:org7a591d9}
\begin{itemize}
\item :BMCOL:
\label{sec:org0a94ecb}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:org5d48e28}
...
\label{sec:org0d5de9e}


\begin{itemize}
\item Example definition
\label{sec:org301ef99}
\begin{itemize}
\item Example definition
\label{sec:orgc7c5221}
\begin{center}
...
\label{sec:org62ff75e}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgbd23379}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:org5f5dd5e}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org295d003}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgc5a5507}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgf448b46}
...
\label{sec:orgbacf102}
\begin{itemize}
\item Example definition
\label{sec:org3dd1584}
\begin{itemize}
\item Example definition
\label{sec:org3379094}
\begin{center}
...
\label{sec:orge4e54c3}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org3339fd3}
\begin{center}
...
\item :BMCOL:
\label{sec:orgfdd0987}



\item Gray Code Quantum Circuit
\label{sec:orgce18b6c}
\uline{Gray Code Quantum Circuit}
...
\label{sec:org79cb214}
\begin{itemize}
\item Example definition
\label{sec:org92bd25c}
\begin{itemize}
\item Example definition
\label{sec:org1e0177a}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org5ec4ba1}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org35c9722}
\begin{center}
...
\item :BMCOL:
\label{sec:org502fbbb}



\item Gray Code Quantum Circuit
\label{sec:orgba7d793}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org184648f}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:orge4377bf}
\begin{itemize}
\item Example definition
\label{sec:org8e928d0}
\begin{itemize}
\item Example definition
\label{sec:orged4e3e8}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org98b85a1}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org4bdbf98}
\begin{center}
...
\item :BMCOL:
\label{sec:orge97e6cb}



\item Gray Code Quantum Circuit
\label{sec:org5ae60ba}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org197ae5f}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org651e1c8}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:org59df3d2}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org87b5c0b}

\begin{itemize}
\item Circuits
\label{sec:org75c9fdb}
\begin{itemize}
\item :BMCOL:
\label{sec:org9b10168}
      \begin{center}
...
\label{sec:org5ee1928}

\begin{itemize}
\item :BMCOL:
\label{sec:orga30145f}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org6814358}
Error sources:
...
\item :BMCOL:
\label{sec:org476d29e}
\begin{itemize}
\item Windows error image
\label{sec:orgd34df30}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org298f522}

\item Best Mapping
\label{sec:org8914c25}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgba72243}
...
\label{sec:org989b1bb}

\begin{itemize}
\item Index
\label{sec:org7aea645}
\begin{itemize}
\item What is the people doing?
\label{sec:org5d659dd}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgf1f7230}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org4d6be8b}
...
\label{sec:orga841eee}

\begin{itemize}
\item SC-17 topology
\label{sec:orgf9d24b3}
\begin{itemize}
\item Images
\label{sec:org61f2371}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:orgcbc73c0}
...
\item Constraints
\label{sec:org42160ea}
\begin{itemize}
\item :BMCOL:
\label{sec:org8e7f4b8}
Constraints:
