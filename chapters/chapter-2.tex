...
\label{sec:orga7f3760}

\section*{Quantum computing}
\label{sec:org4561c8f}
...
Dirac's notation grants the definition of the quantum states as vectors, as in eq. \ref{eq:org78967cd}.
...
E.g. in eq. \ref{eq:orgea58432} the vectors of the ground, excited and the plus superposition -- a quantum state with the same probability to get either \(|0\rangle\) or \(|1\rangle\) -- states are depicted, respectively.
...
\item Quantum Gates
\label{sec:org3205bec}
\end{itemize}
\subsection*{Quantum Circuits}
\label{sec:org5716f94}

\section*{Mapping of quantum circuits}
\label{sec:orga274b93}

\subsection*{Mapping}
\label{sec:orgb0c7a3d}
...
\label{sec:org2e7e04a}

\begin{itemize}
\item Example
\label{sec:orgd1e79ce}
\begin{itemize}
\item Original
\label{sec:org3ba77a4}
...
\label{sec:org4d1429b}
\begin{itemize}
\item :BMCOL:
\label{sec:org2de8514}
The SWAP gate swaps the information between qubits.

\item Dependence graph
\label{sec:orgcbc72c9}
...
\label{sec:org56545f1}


\begin{itemize}
\item Example definition
\label{sec:org4f15161}
\begin{itemize}
\item Example definition
\label{sec:orgbb652a5}
\begin{center}
...
\label{sec:orge92c8f9}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org04df50d}
...
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgcc0177d}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org2f5984f}
\begin{center}
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org98cb640}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:orgac057c0}
...
\label{sec:orgdd06109}
\begin{itemize}
\item Example definition
\label{sec:org45623c8}
\begin{itemize}
\item Example definition
\label{sec:orgc533afc}
\begin{center}
...
\label{sec:orgacb5539}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:org3462b3a}
\begin{center}
...
\item :BMCOL:
\label{sec:org51d4542}



\item Gray Code Quantum Circuit
\label{sec:org20f1cd0}
\uline{Gray Code Quantum Circuit}
...
\label{sec:orgb692c48}
\begin{itemize}
\item Example definition
\label{sec:org004a0bc}
\begin{itemize}
\item Example definition
\label{sec:org653942c}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orga69ab59}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orgf0fb685}
\begin{center}
...
\item :BMCOL:
\label{sec:orgaedf4b0}



\item Gray Code Quantum Circuit
\label{sec:org78b2b6a}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org2f98876}
\begin{center}
\resizebox{\textwidth}{!}{
...
\subsection*{Mapping example. Routing and re-scheduling}
\label{sec:org1c15deb}
\begin{itemize}
\item Example definition
\label{sec:org3e9bd97}
\begin{itemize}
\item Example definition
\label{sec:orgedfbc50}
\begin{center}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org9f53260}
\begin{itemize}
\item :B\(_{\text{structureenv}}\):
\label{sec:orga61cec7}
\begin{center}
...
\item :BMCOL:
\label{sec:orgf777ccc}



\item Gray Code Quantum Circuit
\label{sec:orgd19f81c}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org92074e6}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:orgce2c6b8}
\begin{center}
$\Box$ \text{Cycle}
\end{center}

\item :B\(_{\text{ignoreheading}}\):
\label{sec:org3f9b276}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}
...
\label{sec:org84075c8}

\begin{itemize}
\item Circuits
\label{sec:org0084aa1}
\begin{itemize}
\item :BMCOL:
\label{sec:org7aebbdf}
      \begin{center}
...
\label{sec:orgdccedee}

\begin{itemize}
\item :BMCOL:
\label{sec:org3b3f14b}
\begin{itemize}
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org3be17d1}
Error sources:
...
\item :BMCOL:
\label{sec:orgc4f1faf}
\begin{itemize}
\item Windows error image
\label{sec:orgc87eabc}
\vspace{.5cm}
...
\item :B\(_{\text{ignoreheading}}\):
\label{sec:org0d53442}

\item Best Mapping
\label{sec:org9237e8f}
Ideal mapping should not inject extra errors.

\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:org4820b88}
...
\label{sec:org9fa9d0b}

\begin{itemize}
\item Index
\label{sec:org703c2f6}
\begin{itemize}
\item What is the people doing?
\label{sec:org4830246}
\small
...
\item {\bfseries\sffamily TODO} :B\(_{\text{noteNH}}\):
\label{sec:orgf88d6bb}
\begin{itemize}
\item :B\(_{\text{onlyenv}}\):
\label{sec:org675949b}
...
\label{sec:orgeffef49}

\begin{itemize}
\item SC-17 topology
\label{sec:org31cf693}
\begin{itemize}
\item Images
\label{sec:org5bd0c3c}
\begin{center}
\includegraphics[width=.6\textwidth]{figs/sc-17.eps}
\end{center}

\item Images
\label{sec:orga3845fb}
...
\item Constraints
\label{sec:org265af70}
\begin{itemize}
\item :BMCOL:
\label{sec:org95b8a6a}
Constraints:
