\resizebox{0.45\textwidth}{!}{%
 ...
 \node [purple] at (1,0) {\textbf{Q2}};
 \node [purple] at (11,0) {\textbf{Q3}};
 \node [purple] at (21,0) {\textbf{Q4}};
 \node [purple] at (6,5) {\textbf{Q0}};
 \node [purple] at (6,-5) {\textbf{Q5}};
 \node [purple] at (16,5) {\textbf{Q1}};
 \node [purple] at (16,-5) {\textbf{Q6}};
